...
plot_combined_values_Stacked_with_blank_normalized <- function(df, Title1, Title2) {
  ...
  # 2. Divide the means by the sum of their respective columns
  ...
  plot_all <-df_all_long %>%
    ...
    labs(title = paste(Title1, "vs", Title2, " (All values)"), y = "Sum of Means") 
  # Saving the plots
  # ggsave(filename = paste0("Stacked_bars/", Title1, "_vs_", Title2, "_STACKED__with_BLANK_SUM_sig_normalized.svg"), plot = plot_sig)
  ggsave(filename = paste0("Stacked_bars_normalized/", Title1, "_vs_", Title2, "_STACKED__with_BLANK_SUM_all_normalized.pdf"), plot = plot_all)
}

library(tidyverse)
library(tidyverse)

plot_combined_values_Stacked_with_blank_individual_normalized <- function(df, Title1, Title2) {
  lipid_classes <- c("CAR", "CE", "Cer", "FA", "PC", "PE", "PG", "PI", "PS", "SM", "TAG",'DAG','TAG | DAG','DAG | CE','TAG | DAG | CE')
  lipid_colors <- c("#a6cee3", "#1f78b4", "#b2df8a", "#33a02c", "#fb9a99", "#e31a1c", "#fdbf6f", "#ff7f00", "#808080", "#cab2d6", "#6a3d9a",'#8dd3c7', '#ffffb3', '#bebada', '#fb8072', '#80b1d3')
  ...
  # Saving the plots
  ggsave(filename = paste0("Stacked_bars_individual_normalized/", Title1, "_vs_", Title2, "_STACKED__with_BLANK_all_normalized.pdf"), plot = plot_all)
  # ggsave(filename = paste0("Stacked_bars_individual/", Title1, "_vs_", Title2, "_STACKED__with_BLANK_sig.svg"), plot = plot_sig)
}


plot_pie_charts_normalized <- function(df, Title1, Title2, filename, filename_csv) {
  library(gridExtra)
  lipid_classes <- c("CAR", "CE", "Cer", "FA", "PC", "PE", "PG", "PI", "PS", "SM", "TAG",'DAG','TAG | DAG','DAG | CE','TAG | DAG | CE')
  lipid_colors <- c("#a6cee3", "#1f78b4", "#b2df8a", "#33a02c", "#fb9a99", "#e31a1c", "#fdbf6f", "#ff7f00", "#808080", "#cab2d6", "#6a3d9a",'#8dd3c7', '#ffffb3', '#bebada', '#fb8072', '#80b1d3')
...
for (jj in file_list){
  ...
  plot_combined_values_Stacked_with_blank_normalized(excel_file, Title1, Title2)
  # plot_combined_values_Stacked_with_blank_individual_normalized(excel_file, Title1, Title2)
  plot_pie_charts_normalized(excel_file, Title1, Title2, paste0("Pie_charts_normalized_by_lipid_number/",Title1,Title2,"_normalized_by_number.svg",sep=""), paste0("Pie_charts_normalized_by_lipid_number/",Title1,Title2,"_normalized_by_number.csv",sep=""))
