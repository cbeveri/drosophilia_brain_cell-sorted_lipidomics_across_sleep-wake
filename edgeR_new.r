...
for (jj in file_list){
  ...
  for (condition in conditions) {
    ...
    for (blank_condition in blank_conditions) {
      ...
      ggsave(paste("plots/PCA_", title_for_plot, condition$suffix, blank_condition$suffix, "_with_Eclipse.pdf", sep = ''), width = 12, height = 10)
    }
  }
  ...
  # 
  # # Save the plot
  # ggsave(paste("plots/PCA_",title_for_plot,"all_lipids_old_with_Eclipse.svg",sep=''),width=12,height=10)
