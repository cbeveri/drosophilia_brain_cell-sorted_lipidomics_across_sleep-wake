...
FA_plot_lengths <- function(df, Title1, Title2) {
  ...
  ggsave(filename = paste0("BAR_FA/", Title1, "_vs_", Title2, "_STACKED_FA_ChainLength.pdf"),
         plot = plot_fa)
  ...
  ggsave(filename = paste0("Pie_FA/", Title1, "_PIE_FA_ChainLength.pdf"), plot = pie1)
  ggsave(filename = paste0("Pie_FA/", Title2, "_PIE_FA_ChainLength.pdf"), plot = pie2)
}
